...
public enum Layer
{
	DIFFUSION_N(0, STRING_DIFFUSION_N, COLOR_DIFFUSION_N),
	DIFFUSION_P(1, STRING_DIFFUSION_P, COLOR_DIFFUSION_P),
	POLYSILICON(2, STRING_POLYSILICON, COLOR_POLYSILICON),
	METAL_ONE(3, STRING_METAL_ONE, COLOR_METAL_ONE),
	METAL_TWO(4, STRING_METAL_TWO, COLOR_METAL_TWO),
	METAL_THREE(5, STRING_METAL_THREE, COLOR_METAL_THREE),
	METAL_FOUR(6, STRING_METAL_FOUR, COLOR_METAL_FOUR),
	METAL_FIVE(7, STRING_METAL_FIVE, COLOR_METAL_FIVE),
